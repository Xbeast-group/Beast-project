...
export default function Homepage2() {
  ...
  return (
    <div className="w-full sm:h-screen h-1000 overflow-hidden relative  flex justify-between  bg-black ">
    ...
    <div className=" w-full sm:flex   relative flex-col h-screen">
       ...
       <div className=" w-200 sm:flex   sm:h-screen">
        ...
        className="sm:w-200 w-200 h-300  z-20 object-center sm:top-20 sm:right-35   absolute sm:h-220 object-cover" alt="Landing Image" />
            <h1 className="text-5xl text-white absolute top-140 sm:top-120  sm:left-190 left-40 z-99">THE</h1>
            <h1 className="sm:text-5xl text-6xl text-white absolute top-155 sm:top-135 sm:right-110 right-20 z-99">LEADER</h1>
       ...
       <div className=" w-200 sm:flex absolute sm:top-0 top-180 h-screen">
        ...
        className="w-110  top-15 left-0 object-center absolute h-170 object-cover" alt="Landing Image" />
            <h1 className="text-5xl text-white absolute top-145 sm:top-122 left-40 z-99">THE</h1>
            <h1 className="text-5xl text-white absolute top-160 sm:top-135 left-20 z-99">DESIGNER</h1>        
       ...
       <div className="  w-200  sm:flex sm absolute sm:top-0 top-540 sm:right-142 right-0    h-screen">
        ...
        className="sm:w-71 w-90 h-190  top-20 left-100 sm:left-92  object-bottom absolute sm:h-140 object-cover" alt="Landing Image" />
            <h1 className="text-5xl text-white absolute top-170 sm:top-120 sm:left-115 left-130 z-99">THE</h1>
            <h1 className="sm:text-4xl text-5xl text-white absolute top-185 sm:top-135 sm:left-100 left-105 z-99">PPT MACKER </h1>        
       ...
       <div className=" w-200 sm:flex right-0  absolute sm:left-150 top-360 sm:top-0 h-screen">
        ...
        className="w-110  top-20 right-10 sm:right-20 object-center absolute h-170 object-cover" alt="Landing Image" />
            <h1 className="text-5xl text-white absolute top-150 sm:top-120 right-50 z-99">THE</h1>
            <h1 className="text-5xl text-white absolute top-165 sm:top-135 right-23 z-99">DEVELOPER</h1>
